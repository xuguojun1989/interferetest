...
def get_ZhuxianAggregations(pageSize, grade, type, termType, pageIndex):
    url = "http://gatewaytest.gaosiedu.com/reg/api/30/Class/ClassTypes"
    params = {
        "pageSize": pageSize,
        "grade": grade,
        "type": type,
...
if __name__ == '__main__':
    get_ZhuxianAggregations(pageSize=5, grade=10, type=0, termType=0, pageIndex=1)
